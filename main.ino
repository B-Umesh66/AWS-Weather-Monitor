...
// WiFi credentials
const char WIFI_SSID[] = "wifi-ssid";//replace by your ssid
const char WIFI_PASSWORD[] = "Password";//replace by your password

// Device name from AWS
const char THINGNAME[] = "ESP8266";

// MQTT broker host address from AWS
const char MQTT_HOST[] = "an0gis9uj8wes-ats.iot.ap-south-1.amazonaws.com";
